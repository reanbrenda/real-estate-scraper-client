...
import EnergyRatingChart from "../../../components/EnergyRatingChart";
          ...
          <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
              ...
              <div className="max-w-5xl mx-auto bg-white shadow-xl rounded-2xl overflow-hidden">
                  <div className="relative">
                      ...
                      />
                      <div className="absolute top-4 right-4 bg-[#0C573C] text-white px-4 py-2 rounded-lg shadow-md">
                  ...
                  <div className="p-8">
                      ...
                      <div>
                          <a 
                              className="underline text-2xl text-[#0C573C] hover:text-green-800 visited:text-purple-600" 
                              href={property.link} 
                              target="_blank" 
